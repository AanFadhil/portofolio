...
const Home = () => {
  ...
  return (
    <Layout>
      <div className="px-2 md:px-0 block mt-0 md:mt-20 align-text-bottom w-screen" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
        <div className="max-w-3xl mx-auto bg-gray-50 shadow-md flex flex-col overflow-hidden md:flex-row rounded-3xl  transition duration-300 transform hover:-translate-y-2 hover:scale-105 ease-out hover:shadow-2xl">
          {/* <img src={"/potrait.png"} className=" w-full md:w-80 md:h-80 object-contain shadow-none   rounded-none h-32 mx-auto md:mx-0 mt-auto md:mt-0 max-w-lg" /> */}
